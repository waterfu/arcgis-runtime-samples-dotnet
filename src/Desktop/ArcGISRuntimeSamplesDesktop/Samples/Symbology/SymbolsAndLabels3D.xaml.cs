...
namespace ArcGISRuntime.Samples.Desktop
{
	...
	/// </summary>
	/// <title>Symbols and Labels 3D</title>
	/// <category>Symbology</category>
	public sealed partial class SymbolsAndLabels3D : UserControl
	{
		public SymbolsAndLabels3D()
		{
		...
		{
			var gOverlay = MySceneView.GraphicsOverlays["labelGraphicsOverlay"];

			gOverlay.Graphics.Add(new Graphic(new MapPoint(-60, 48, SpatialReferences.Wgs84), (Symbol)Resources["NumberedMarkerSymbol1"]));
			gOverlay.Graphics.Add(new Graphic(new MapPoint(-50, 39, SpatialReferences.Wgs84), (Symbol)Resources["NumberedMarkerSymbolA"]));
			gOverlay.Graphics.Add(new Graphic(new MapPoint(-40, 48, SpatialReferences.Wgs84), (Symbol)Resources["NumberedMarkerSymbol1"]));
			gOverlay.Graphics.Add(new Graphic(new MapPoint(-30, 39, SpatialReferences.Wgs84), (Symbol)Resources["NumberedMarkerSymbolA"]));
			gOverlay.Graphics.Add(new Graphic(new MapPoint(-20, 40, SpatialReferences.Wgs84), (Symbol)Resources["NumberedMarkerSymbol1"]));
			gOverlay.Graphics.Add(new Graphic(new MapPoint(-10, 39, SpatialReferences.Wgs84), (Symbol)Resources["NumberedMarkerSymbolA"]));
