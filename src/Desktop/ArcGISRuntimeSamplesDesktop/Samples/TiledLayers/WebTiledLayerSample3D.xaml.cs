...
{
    /// <summary>
    /// Demonstrates adding a Web tiled layer to a Scene in XAML, and changing layer properties in code behind.
    /// Also demonstrates including Attribution as per Terms of Use for the various layers. 
    /// </summary>
    /// <title>Web Tiled Layer 3D</title>
    /// <category>Layers</category>
    /// <subcategory>Tiled Layers</subcategory>
    public partial class WebTiledLayerSample3D : UserControl
    {

        public WebTiledLayerSample3D()
        {
            InitializeComponent();

			MySceneView.SpatialReferenceChanged += MyMapView_SpatialReferenceChanged;
        }
        ...
        {
			if (MySceneView.SpatialReference == null)
                return;
